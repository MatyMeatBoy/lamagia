...
const C13_PRIMAL_VIGOR = () => make({ name: "Primal Vigor", type_line: "Enchantment", mana_cost: "{4}{G}", cmc: 5, oracle_text: "If one or more +1/+1 counters would be put on a creature, twice that many +1/+1 counters are put on it instead.\nIf one or more tokens would be created, twice that many of those tokens are created instead.", oracle_id: "c665544f-557b-4631-a1dc-39571470ca2e", scryfall_id: "c665544f-557b-4631-a1dc-39571470ca2e" });
