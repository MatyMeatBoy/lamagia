...
const TRIGGER_TEMPLATES: readonly TriggerTemplate[] = [
  ...
  // `nontoken` is a real event restriction, not a display qualifier; keep it
  // on the shared death-trigger definition so token deaths cannot create a
  // replacement token (CR 603.1, 603.2).
