...
- Catalog cards: **341**
- Fully implemented: **191**
- Unfinished: **150**, of which **72** are a single line away
...
| 7 | 1 | 7 | 1 | keyword-ability | `c13-entwine-cost` | `entwine {cost}` |
| 8 | 1 | 8 | 1 | keyword-ability | `c13-forecast-cost-reveal-from` | `forecast - {cost}, reveal ~ from your hand: each player draws <n> card` |
| 9 | 1 | 9 | 1 | keyword-ability | `c13-graft` | `graft <n>` |
...
| 13 | 1 | 13 | 1 | other | `c13-prevent-all-combat-damage` | `prevent all combat damage that would be dealt to ~` |
| 14 | 1 | 14 | 1 | other | `c13-put-target-nonland-permanent` | `put target nonland permanent into its owner's library just beneath the top <n> cards of that library` |
| 15 | 1 | 15 | 1 | activated | `c13-remove-counter-from-deals` | `remove <n> +<n>/+<n> counter from ~: it deals <n> damage to any target` |
| 16 | 1 | 16 | 1 | other | `c13-return-all-permanents-the` | `return all permanents of the color of your choice to their owners' hands` |
| 17 | 1 | 17 | 1 | activated | `c13-sacrifice-beast-you-gain` | `sacrifice <n> beast: you gain <n> life` |
| 18 | 1 | 18 | 1 | token | `c13-sacrifice-creatures-create-red` | `sacrifice <n> creatures: create <n> <n>/<n> red beast creature token named carnivore` |
| 19 | 1 | 19 | 1 | other | `c13-then-you-have-more` | `then if you have more life than <n> opponent, draw <n> card` |
| 20 | 1 | 20 | 1 | other | `c13-untap-all-green-and` | `untap all green and/or blue creatures you control during each other player's untap step` |
| 21 | 1 | 21 | 1 | other | `c13-until-end-turn-creatures` | `until end of turn, creatures target player controls lose all abilities and have base power and toughness <n>/<n>` |
| 22 | 1 | 22 | 1 | triggered | `c13-when-sharuum-enters-you` | `when sharuum enters, you may return target artifact card from your graveyard to the battlefield` |
| 23 | 1 | 23 | 1 | triggered | `c13-when-you-cast-create` | `when you cast ~, create <n> <n>/<n> red kobold creature tokens named kobolds of kher keep, where <n> is the amount of mana spent to cast it` |
| 24 | 1 | 24 | 1 | triggered | `c13-when-you-cycle-you` | `when you cycle ~, you may have it deal <n> damage to each creature` |
| 25 | 1 | 25 | 1 | triggered | `c13-when-you-cycle-you-2` | `when you cycle ~, you may have target creature gain fear until end of turn` |
| 26 | 1 | 26 | 1 | counters | `c13-when-enters-destroy-all` | `when ~ enters, destroy all artifacts and enchantments. put <n> +<n>/+<n> counter on ~ for each permanent destroyed this way` |
| 27 | 1 | 27 | 1 | triggered | `c13-when-enters-exile-another` | `when ~ enters, exile another target permanent. return that card to the battlefield under its owner's control at the beginning of the next end step` |
| 28 | 1 | 28 | 1 | triggered | `c13-when-enters-return-target` | `when ~ enters, return target artifact card from your graveyard to your hand. you gain life equal to that card's mana value` |
| 29 | 1 | 29 | 1 | triggered | `c13-when-enters-return-target-2` | `when ~ enters, return target creature card from your graveyard to the battlefield. you lose life equal to that card's mana value` |
| 30 | 1 | 30 | 1 | triggered | `c13-when-enters-sacrifice-unless` | `when ~ enters, sacrifice it unless {cost} was spent to cast it` |
| 31 | 1 | 31 | 1 | static-continuous | `c13-when-enters-tap-target` | `when ~ enters, tap target creature <n> opponent controls. that creature doesn't untap during its controller's untap step for as long as you control ~` |
| 32 | 1 | 32 | 1 | triggered | `c13-when-enters-target-opponent` | `when ~ enters, target opponent creates <n> <n>/<n> blue faerie creature tokens with flying` |
| 33 | 1 | 33 | 1 | triggered | `c13-when-enters-you-may` | `when ~ enters, you may return target instant or sorcery card from your graveyard to your hand` |
| 34 | 1 | 34 | 1 | triggered | `c13-whenever-creature-dies-untap` | `whenever <n> creature dies, untap ~` |
| 35 | 1 | 35 | 1 | triggered | `c13-whenever-creature-you-control` | `whenever <n> creature you control enters, it deals damage equal to its power to any target` |
| 36 | 1 | 36 | 1 | triggered | `c13-whenever-creature-you-control-2` | `whenever <n> creature you control with power <n> or greater enters, you may have ~ deal <n> damage to any target` |
| 37 | 1 | 37 | 1 | triggered | `c13-whenever-opponent-draws-card` | `whenever <n> opponent draws <n> card, ~ deals <n> damage to that player` |
| 38 | 1 | 38 | 1 | triggered | `c13-whenever-player-draws-card` | `whenever <n> player draws <n> card, ~ deals <n> damage to that player` |
| 39 | 1 | 39 | 1 | triggered | `c13-whenever-spell-ability-causes` | `whenever <n> spell or ability causes its controller to shuffle their library, that player puts <n> card from their hand on top of their library` |
| 40 | 1 | 40 | 1 | triggered | `c13-whenever-another-creature-you` | `whenever another creature you control dies, it deals damage equal to its power to target player or planeswalker` |
...
### 7. `c13-entwine-cost` — finishes 1 cards
...
### 8. `c13-forecast-cost-reveal-from` — finishes 1 cards
...
### 10. `c13-was-kicked-has-split` — finishes 1 cards
...
### 11. `c13-landfall-whenever-land-you` — finishes 1 cards
...
### 12. `c13-players-have-maximum-hand` — finishes 1 cards
...
### 13. `c13-prevent-all-combat-damage` — finishes 1 cards
...
### 14. `c13-put-target-nonland-permanent` — finishes 1 cards
...
### 15. `c13-remove-counter-from-deals` — finishes 1 cards
...
### 16. `c13-return-all-permanents-the` — finishes 1 cards
...
### 17. `c13-sacrifice-beast-you-gain` — finishes 1 cards
...
### 18. `c13-sacrifice-creatures-create-red` — finishes 1 cards
...
### 19. `c13-then-you-have-more` — finishes 1 cards
...
### 20. `c13-untap-all-green-and` — finishes 1 cards
...
### 21. `c13-until-end-turn-creatures` — finishes 1 cards
...
### 22. `c13-when-sharuum-enters-you` — finishes 1 cards
...
### 23. `c13-when-you-cast-create` — finishes 1 cards
...
### 24. `c13-when-you-cycle-you` — finishes 1 cards
...
### 25. `c13-when-you-cycle-you-2` — finishes 1 cards
...
### 26. `c13-when-enters-destroy-all` — finishes 1 cards
...
### 27. `c13-when-enters-exile-another` — finishes 1 cards
...
### 28. `c13-when-enters-return-target` — finishes 1 cards
...
### 29. `c13-when-enters-return-target-2` — finishes 1 cards
...
### 30. `c13-when-enters-sacrifice-unless` — finishes 1 cards
...
### 31. `c13-when-enters-tap-target` — finishes 1 cards
...
### 32. `c13-when-enters-target-opponent` — finishes 1 cards
...
### 33. `c13-when-enters-you-may` — finishes 1 cards
...
### 34. `c13-whenever-creature-dies-untap` — finishes 1 cards
...
### 35. `c13-whenever-creature-you-control` — finishes 1 cards
...
### 36. `c13-whenever-creature-you-control-2` — finishes 1 cards
...
### 37. `c13-whenever-opponent-draws-card` — finishes 1 cards
...
### 38. `c13-whenever-player-draws-card` — finishes 1 cards
...
### 39. `c13-whenever-spell-ability-causes` — finishes 1 cards
...
### 40. `c13-whenever-another-creature-you` — finishes 1 cards
