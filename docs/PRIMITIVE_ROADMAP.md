...
- Fully implemented: **10,789**
- Unfinished: **27,922**, of which **15,006** are a single line away
- This queue's 40 entries would finish **780** more cards
...
| 2 | 49 | 98 | 103 | 49 | keyword-ability | `-convoke` | `convoke` |
| 3 | 48 | 146 | 198 | 48 | keyword-ability | `-crew` | `crew <n>` |
| 4 | 33 | 179 | 47 | 33 | keyword-ability | `-infect` | `infect` |
| 5 | 28 | 207 | 60 | 27 | keyword-ability | `-madness-cost` | `madness {cost}` |
| 6 | 26 | 233 | 72 | 26 | keyword-ability | `-suspend-cost` | `suspend <n>-{cost}` |
| 7 | 25 | 258 | 57 | 25 | keyword-ability | `-unearth-cost` | `unearth {cost}` |
| 8 | 23 | 281 | 32 | 23 | transform | `-the-beginning-each-upkeep` | `at the beginning of each upkeep, if no spells were cast last turn, transform ~` |
| 9 | 21 | 302 | 35 | 21 | keyword-ability | `-cascade` | `cascade` |
| 10 | 20 | 322 | 42 | 20 | keyword-ability | `-bestow-cost` | `bestow {cost}` |
| 11 | 20 | 342 | 37 | 20 | other | `-daybound` | `daybound` |
| 12 | 20 | 362 | 35 | 20 | other | `-bushido` | `bushido <n>` |
| 13 | 19 | 381 | 104 | 18 | other | `-ward-cost` | `ward {cost}` |
| 14 | 19 | 400 | 41 | 18 | other | `-toxic` | `toxic <n>` |
| 15 | 19 | 419 | 32 | 18 | keyword-ability | `-buyback-cost` | `buyback {cost}` |
| 16 | 18 | 437 | 25 | 17 | activated | `-cost-prevent-the-next` | `{cost}: prevent the next <n> damage that would be dealt to any target this turn` |
| 17 | 18 | 455 | 22 | 18 | other | `-all-slivers-have-name` | `all slivers have <name>` |
| 18 | 17 | 472 | 25 | 17 | keyword-ability | `-soulshift` | `soulshift <n>` |
| 19 | 17 | 489 | 23 | 17 | other | `-enchanted-creature-has-name` | `enchanted creature has <name>` |
| 20 | 16 | 505 | 134 | 16 | keyword-ability | `-devoid` | `devoid` |
| 21 | 16 | 521 | 54 | 16 | other | `-foretell-cost` | `foretell {cost}` |
| 22 | 15 | 536 | 32 | 14 | other | `-disturb-cost` | `disturb {cost}` |
...
| 26 | 14 | 594 | 27 | 14 | keyword-ability | `-wither` | `wither` |
| 27 | 14 | 608 | 24 | 14 | keyword-ability | `-improvise` | `improvise` |
| 28 | 14 | 622 | 23 | 14 | keyword-ability | `-bloodthirst` | `bloodthirst <n>` |
| 29 | 14 | 636 | 22 | 14 | keyword-ability | `-dash-cost` | `dash {cost}` |
| 30 | 14 | 650 | 25 | 13 | other | `-backup` | `backup <n>` |
| 31 | 14 | 664 | 35 | 11 | other | `-can-blocked-creatures-with` | `~ can't be blocked by creatures with power <n> or less` |
| 32 | 14 | 678 | 18 | 14 | other | `-enchanted-land-has-name` | `enchanted land has <name>` |
| 33 | 14 | 692 | 15 | 13 | triggered | `-when-becomes-the-target` | `when ~ becomes the target of <n> spell or ability, sacrifice it` |
| 34 | 13 | 705 | 29 | 13 | other | `-delve` | `delve` |
| 35 | 13 | 718 | 28 | 11 | keyword-ability | `-flanking` | `flanking` |
| 36 | 13 | 731 | 20 | 10 | triggered | `-when-enters-exile-target` | `when ~ enters, exile target nonland permanent <n> opponent controls until ~ leaves the battlefield` |
| 37 | 13 | 744 | 19 | 13 | keyword-ability | `-living-weapon` | `living weapon` |
| 38 | 12 | 756 | 57 | 12 | keyword-ability | `-cumulative-upkeep-cost` | `cumulative upkeep {cost}` |
| 39 | 12 | 768 | 22 | 12 | keyword-ability | `-splice-onto-arcane-cost` | `splice onto arcane {cost}` |
| 40 | 12 | 780 | 16 | 11 | other | `-fabricate` | `fabricate <n>` |
...
### 2. `-convoke` — finishes 49 cards

- Template: `convoke`
- Family: keyword-ability
- Appears in 103 unfinished cards; it is the last blocker for 49.
- One-line review candidates: **49**.
...
### 3. `-crew` — finishes 48 cards

- Template: `crew <n>`
- Family: keyword-ability
- Appears in 198 unfinished cards; it is the last blocker for 48.
...
Cards finished (first 12): Adventurer's Airship, Aethersphere Harvester, Air Response Unit, Aradara Express, Ballista Charger, Big Wheel, Bomat Bazaar Barge, Broadcast Rambler, Brute Suit, Careening Mine Cart, Clamorous Ironclad, Consulate Dreadnought.
...
### 4. `-infect` — finishes 33 cards

- Template: `infect`
- Family: keyword-ability
- Appears in 47 unfinished cards; it is the last blocker for 33.
- One-line review candidates: **33**.
...
### 6. `-suspend-cost` — finishes 26 cards
...
### 7. `-unearth-cost` — finishes 25 cards
...
### 10. `-bestow-cost` — finishes 20 cards
...
### 13. `-ward-cost` — finishes 19 cards

- Template: `ward {cost}`
- Family: other
- Appears in 104 unfinished cards; it is the last blocker for 19.
...
Cards finished (first 12): Archive Dragon, Blue Marvel, Adam Brashear, Burly Breaker // Dire-Strain Demolisher, Campus Composer // Aqueous Aria, Dirgur Island Dragon // Skimming Strike, Harmonious Grovestrider, Horned Loch-Whale // Lagoon Breach, Human, Lake-town Mariners // Gone Fishing, Marauding Brinefang, Punk Frogs, Red Ghost, Intangible Genius.
...
### 18. `-soulshift` — finishes 17 cards
...
### 19. `-enchanted-creature-has-name` — finishes 17 cards
...
### 20. `-devoid` — finishes 16 cards

- Template: `devoid`
- Family: keyword-ability
- Appears in 134 unfinished cards; it is the last blocker for 16.
...
Cards finished (first 12): Blinding Drone, Emrakul's Messenger, Havoc Sower, Herald of Kozilek, Kozilek's Shrieker, Maw of Kozilek, Oblivion Strike, Prophet of Distortion, Reality Hemorrhage, Slaughter Drone, Snapping Voidcraw, Spawn-Gang Commander.
...
### 21. `-foretell-cost` — finishes 16 cards
...
### 22. `-disturb-cost` — finishes 15 cards
...
### 26. `-wither` — finishes 14 cards

- Template: `wither`
- Family: keyword-ability
- Appears in 27 unfinished cards; it is the last blocker for 14.
- One-line review candidates: **14**.
...
Cards finished (first 12): Boggart Ram-Gang, Cinderbones, Duergar Cave-Guard, Harvest Gwyllion, Hateflayer, Juvenile Gloomwidow, Oona's Gatewarden, Puncture Blast, Rendclaw Trow, Rustrazor Butcher, Scuzzback Scrapper, Sickle Ripper.
...
### 27. `-improvise` — finishes 14 cards
...
### 28. `-bloodthirst` — finishes 14 cards
...
### 29. `-dash-cost` — finishes 14 cards
...
### 31. `-can-blocked-creatures-with` — finishes 14 cards
...
### 32. `-enchanted-land-has-name` — finishes 14 cards
...
### 33. `-when-becomes-the-target` — finishes 14 cards
...
### 36. `-when-enters-exile-target` — finishes 13 cards
...
### 37. `-living-weapon` — finishes 13 cards
...
### 38. `-cumulative-upkeep-cost` — finishes 12 cards
...
### 39. `-splice-onto-arcane-cost` — finishes 12 cards
...
### 40. `-fabricate` — finishes 12 cards
