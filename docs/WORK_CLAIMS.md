...
| `rules-c13-reprint-equivalence` | `codex/c13-equipment-cluster` | Verify C13 reprints reuse existing oracle-driven rules for Chaos Warp, Command Tower, and Decree of Pain | Ready for integrator review |
