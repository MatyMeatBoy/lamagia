...
| `c13-oracle-damage-triggered-shape` | `codex/c13-slice` | Reusable optional cycling trigger that deals parameterized damage to each creature, applied to Slice and Dice (CR 603.1, 603.2, 609.3) | active |
