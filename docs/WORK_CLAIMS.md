...
| --- | --- | --- | --- | --- |
| `c13-wonder-graveyard-static` | Graveyard static keyword grant conditioned on controlling an Island for Wonder (`232284f7-c623-4895-9ab9-8b1a39926830`) | `codex/c13-wonder-graveyard` | active | 2026-09-04 |
