...
| `rules-c13-landfall-pump` | `codex/c13-equipment-cluster` | Reusable trigger-self P/T plus temporary keyword effect for Landfall cards such as Baloth Woodcrasher | In progress |
