...
| `c13-global-no-maximum-hand-size` | Static `Players have no maximum hand size` effect applies to every player (CR 514.1) | `codex/c13-global-hand-limit-a32` | active | 2026-09-04 |
