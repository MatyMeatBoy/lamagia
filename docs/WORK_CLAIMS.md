...
| `c13-oracle-modify-stats-static` | Wight of Precinct Six: dynamic +1/+1 for each creature card in all graveyards (CR 604.3, 613.4) | `codex/c13-priority-f99` | active | 2026-09-04 |
