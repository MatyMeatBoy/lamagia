...
| `rules-c13-multi-basic-search` | Multi-card basic-land searches with ordered destinations for Cultivate, Armillary Sphere, and Burnished Hart | `codex/c13-equipment-cluster` | merged (pending local integration commit) | 2026-09-04 |
