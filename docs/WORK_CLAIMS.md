...
| `c13-oracle-damage-triggered-shape-2` | `codex/c13-diviner` | Reusable combat-damage event-player draw primitive for `you and that player each draw that many cards`, applied to Diviner Spirit (CR 603.1, 603.2, 120.2) | active |
