...
| `rules-counter-unless-pay-and-return-land-alternative` | Daze and Mana Leak-family wording: the targeted spell's controller may pay the printed mana cost to avoid countering, plus returning a matching Island as an alternative cost; both use reusable stack-choice and alternative-cost plumbing (CR 601.2b, 601.2f, 608.2b) | `worker-05` | active | 2026-09-05 |
