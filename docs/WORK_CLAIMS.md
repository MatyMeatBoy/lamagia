...
| `c13-modern-self-reference-etb-sweep` | `feat/activated-abilities-and-triggers` | Normalize modern `this creature enters` Bane of Progress wording into the existing artifact/enchantment sweep-and-counters primitive | active |
| `c13-life-gained-counter-scaling` | `feat/activated-abilities-and-triggers` | Reuse life-gained event amount for Cradle of Vitality's optional paid counters | active |
