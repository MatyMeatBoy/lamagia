...
| `c14-fog-bank-combat-prevention` | claude-c14 | done | Fog Bank, Sphinx of Jwar Isle |
| `c14-mutilate-swamp-anthem` | claude-c14 | done | Mutilate, Beastmaster Ascension |
| `c14-upkeep-count-conditions` | claude-c14 | done | Kemba Kha Regent, Emeria the Sky Ruin |
| `c14-creatures-died-this-turn` | claude-c14 | done | Tragic Slip (Morbid) |
| `c14-morbid-triggers` | claude-c14 | done | Reaper from the Abyss |
| `c14-abolisher-rush` | claude-c14 | done | Grand Abolisher, Rush of Knowledge |
| `c14-death-scaled-tokens` | claude-c14 | done | Spoils of Blood, Fresh Meat |
| `c14-martial-coup-incite` | claude-c14 | done | Martial Coup, Incite Rebellion |
| `c14-flashback` | claude-c14 | done | Faithless Looting (+63 catalog) |
| `c14-counter-removal` | claude-c14 | done | Aether Snap, Black Suns Zenith, Vampire Hexmage |
| `c14-extort-grant` | claude-c14 | done | Pontiff of Blight |
...
| `c14-magmaquake` | claude-c14 | done | Magmaquake + planeswalker damage |
| `c14-ghoulcaller-gisa` | claude-c14 | done | Ghoulcaller Gisa |
| `c14-syphon-tendrils-nekrataal` | claude-c14 | done | Syphon Mind, Tendrils of Corruption, Nekrataal |
| `c14-praetors-counsel` | claude-c14 | done | Praetors Counsel |
...
| `c14-bosh-ghost-quarter` | claude-c14 | done | Bosh Iron Golem, Ghost Quarter |
| `c14-tectonic-edge` | claude-c14 | done | Tectonic Edge |
...
| `c14-harrow-extra-land` | claude-c14 | done | Harrow + extra land drops |
| `c14-x-activated-cost` | claude-c14 | done | Silklash Spider + {X} activated abilities |
| `c14-copy-token` | claude-c14 | done | Cackling Counterpart |
| `c14-rite-of-replication` | claude-c14 | done | Rite of Replication |
| `c14-drana-x-pump-drain` | claude-c14 | done | Drana, Kalastria Bloodchief |
| `c14-cast-from-hand-gate` | claude-c14 | done | Angel of the Dire Hour |
| `c14-breaching-leviathan` | claude-c14 | done | Breaching Leviathan |
| `c14-serra-avatar` | claude-c14 | done | Serra Avatar |
| `c14-mentor-of-the-meek` | claude-c14 | done | Mentor of the Meek |
| `c14-necromantic-selection` | claude-c14 | done | Necromantic Selection |
| `c14-offering-cycle` | claude-c14 | done | Intellectual Offering, Sylvan Offering |
| `c14-benevolent-offering` | claude-c14 | done | Benevolent Offering |
...
| `c14-wing-shards-storm` | claude-c14 | done | Wing Shards (+19 catalog via Storm no-op) |
