...
| `c13-oracle-create-token-triggered` | `codex/c13-sekuar` | Reusable nontoken creature death trigger that creates a typed token, applied to Sek'Kuar, Deathkeeper (CR 603.1, 603.2, 700.2) | active |
