...
| `c13-prevent-all-combat-damage` | Prevent all combat damage that would be dealt to the source creature, reusable for Guard Gomazoa (CR 615.1, 702.19) | `codex/c13-guard-gomazoa-ebc` | active | 2026-09-04 |
