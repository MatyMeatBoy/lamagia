...
| `rules-c13-reprint-equivalence` | Verify C13 reprints reuse existing oracle-driven rules for Command Tower and Decree of Pain; retain an Army of the Damned ID scenario | `codex/c13-equipment-cluster` | merged (`811b41a`) | 2026-09-04 |
