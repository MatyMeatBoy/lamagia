...
| `c13-oracle-other-triggered-shape-3` | `codex/c13-dirge` | Reusable cycling-trigger normalization for optional `have target creature gain <keyword> until end of turn`, applied to Dirge of Dread (CR 603.1, 603.2, 602.2) | active |
