...
| `c13-oracle-modify-stats-static-2` | `codex/c13-wight` | Reusable characteristic-defining power/toughness value from creature cards in opponents' graveyards, applied to Wight of Precinct Six (CR 604.3, 613.4) | active |
