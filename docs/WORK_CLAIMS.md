...
| `c13-entwine` | Parameterized Entwine additional cost combines every modal branch and preserves ordered targets (CR 702.42) | `codex/c13-entwine-3ffe` | active | 2026-09-04 |
