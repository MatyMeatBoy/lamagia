...
| `c13-hunted-troll` | Hunted Troll's ETB target-opponent token creation reuses the target-player token primitive (CR 603.2, 111.2, 111.10) | `codex/c13-hunted-troll-f99` | active | 2026-09-05 |
