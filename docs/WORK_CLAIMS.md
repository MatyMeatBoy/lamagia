...
| `c13-oracle-damage-triggered-shape-2` | `codex/c13-diviner` | Reusable combat-damage trigger that draws the event player and the damaged player the event amount (CR 603.2, 120.2a, 121.2) | active |
