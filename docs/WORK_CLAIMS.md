...
| `rules-c13-reprint-equivalence` | Verify C13 reprints reuse existing oracle-driven rules for Army of the Damned, Command Tower, and Decree of Pain | `codex/c13-equipment-cluster` | merged (`811b41a`) | 2026-09-04 |
