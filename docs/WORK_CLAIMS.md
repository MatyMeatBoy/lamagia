...
| `rules-modify-creatures-commander2017` | Modify creatures you control effects for Commander 2017 cards | `worker-02` | active | 2026-09-04 |
...
| `rules-damage-prevention` | Activated abilities that prevent damage (Tornellar Protector pattern) | `worker-02` | active | 2026-09-03 |
