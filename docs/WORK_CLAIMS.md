...
| `c13-protection` | Parse color protection and enforce its targeting, blocking, and combat-damage prevention rules; Sphinx of the Steel Wind | `feat/activated-abilities-and-triggers` | active | 2026-09-04 |
