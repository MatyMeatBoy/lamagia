...
| `c13-put-target-nonland-permanent` | Insert a target nonland permanent beneath the top X cards of its owner’s library, reusable for Unexpectedly Absent (CR 701.19, 701.20) | `codex/c13-library-insert-f99` | active | 2026-09-04 |
