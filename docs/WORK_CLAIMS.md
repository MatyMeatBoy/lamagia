...
| `arsenal-rhystic-study` | Rhystic Study asks the spell's caster to pay {1}; if they decline, its controller draws a card (CR 603.2, 603.5, 117.1, 121.1) | `codex/c13-equipment-cluster` | active | 2026-09-04 |
