...
- Scope: **catalog**
- One-line cards: **15,070**
- Cards with a reusable existing primitive hint: **11,347**
- Cards needing new primitive review: **3,723**
- Templates: **11,982**
...
The JSON contains the remaining 14,570 cards. Regenerate with `--markdown-max-cards 0` for a full Markdown listing.
