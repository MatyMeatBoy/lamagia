...
- Scope: **catalog**
- One-line cards: **15,007**
- Cards with a reusable existing primitive hint: **11,262**
...
The JSON contains the remaining 14,507 cards. Regenerate with `--markdown-max-cards 0` for a full Markdown listing.
