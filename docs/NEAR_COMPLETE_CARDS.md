...
- Scope: **catalog**
- One-line cards: **15,023**
- Cards with a reusable existing primitive hint: **11,287**
- Cards needing new primitive review: **3,736**
- Templates: **11,986**
...
The JSON contains the remaining 14,523 cards. Regenerate with `--markdown-max-cards 0` for a full Markdown listing.
