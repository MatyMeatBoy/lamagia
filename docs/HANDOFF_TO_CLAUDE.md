...
- **Unique engine profiles:** 9,355 / 38,711 fully implemented. These are
...
- **Commander 2013:** 268 / 341 unique cards (78.6%), 73 pending.
...
Rules suite: **596 passing tests**. The latest local source checkpoint also
adds Mirror Entity's reusable X/X/all-creature-types characteristic effect;
generated export: **9,355/38,711** profiles and C13 **268/341**.
