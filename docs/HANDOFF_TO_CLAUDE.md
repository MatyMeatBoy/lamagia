...
- **Unique engine profiles:** 10,118 / 38,711 fully implemented. These are
  deduplicated by stable `oracle_id`; one implementation covers every printing.
- **Edition memberships:** 26,096 / 84,990 implemented (30.7%) across 685
...
one one-line candidate: Sudden Spoiling. The global queue is now 15,151
one-line profiles, 11,441 of them reusable, after the Fling, Incinerate, Voltaic
...
target-controller-rider, and opponent-life-gain-prevention primitives were added;
the C13
