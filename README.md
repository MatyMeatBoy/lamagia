...
Published coverage is currently **10,031/38,711 unique engine profiles** and
**25,829/84,990 edition memberships (30.4%)**. The public set map uses edition
memberships; reprints therefore appear there separately even though their
rules implementation is shared. Current C13 is **290/341** and C14 is
