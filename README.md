...
Published coverage is currently **9,311/38,711 unique engine profiles** and
**23,507/84,990 edition memberships (27.7%)**. The public set map uses edition
memberships; reprints therefore appear there separately even though their
rules implementation is shared. Current C13 is **258/341** and C14 is
