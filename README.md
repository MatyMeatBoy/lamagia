...
Published coverage is currently **9,082/38,711 unique engine profiles** and
**22,564/84,990 edition memberships (26.5%)**. The public set map uses edition
memberships; reprints therefore appear there separately even though their
rules implementation is shared. Current C13 is **223/341** and C14 is
**196/322**. See the [current handoff checkpoint](docs/HANDOFF_TO_CLAUDE.md).
