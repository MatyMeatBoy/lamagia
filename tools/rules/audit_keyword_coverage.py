...
IMPLEMENTED = {
    ...
    "fear": "artifact-or-black blocking restriction",
    ...
    "intimidate": "artifact-or-color blocking restriction",
    "landwalk": "combat evasion by land subtype",
    "lifelink": "combat damage life gain",
    "menace": "blocking restriction",
    "shadow": "symmetric shadow evasion and blocking",
    "reach": "flying blocking",
    "shroud": "target legality",
    "trample": "combat damage assignment",
    "vigilance": "attack does not tap",
    "horsemanship": "symmetric horsemanship evasion and blocking",
    "exalted": "sole-attacker temporary pump trigger",
    "prowess": "noncreature-spell temporary pump trigger",
    "split second": "stack response restriction",
    ...
    "echo": "upkeep payment or sacrifice trigger",
    "flashback": "graveyard alternative cast and exile replacement",
    "rebound": "exile-on-resolution and next-upkeep recast",
